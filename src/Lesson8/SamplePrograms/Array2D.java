...
public class Array2D {
    ...
    public static void main(String[] args) {
        int nums[][] = {{34,56,67,95},{43,67,78,35},{67,45,45,34}};
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
        ...
        int total = sum(nums); //call sum, send in 2d nums array
        ...
        int avg [] = getAvg(nums); //get back average of the 3 students (rows)
